...
(define (domain woodworking)
  ...
  (:action do-immersion-varnish
    :parameters (?m - immersion-varnisher ?x - part 
  ...
  (:action do-spray-varnish
    :parameters (?m - spray-varnisher ?x - part 
                 ?newcolour - acolour ?surface - surface)
    :precondition (and
            (available ?x)
            (has-colour ?m ?newcolour)
  ...
  (:action do-grind
    :parameters (?m - grinder ?x - part ?oldsurface - surface
                 ?oldcolour - acolour 
  ...
  (:action do-plane
    :parameters (?m - planer ?x - part ?oldsurface - surface
  ...
  (:action cut-board-small
    :parameters (?m - highspeed-saw ?b - board ?p - part ?w - awood
  ...
  (:action do-saw-small
    :parameters (?m - saw ?b - board ?p - part ?w - awood
                 ?surface - surface ?size_before ?size_after - aboardsize) 
    :precondition (and 
            (unused ?p)
            (goalsize ?p small)
