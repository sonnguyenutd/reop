...
public class CommunicateRockData extends Action {

	public CommunicateRockData(String txt) {
...
//		String y = parts[5];
		addPre("at-" + rover + "-" + x);
		addPre("have_rock_analysis-" + rover + "-" + p);
		addPEffect("communicated_rock_data-" + p);
	}
	@Override
	public int hashCode() {
