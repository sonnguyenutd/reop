...
public class PlanningGraph {
	...
	public boolean isFixedPoint() {
		...
		return last.P.props.equals(prev.P.props);
	}
	...
	private Solution search(Set<String> goal, Solution currentSolution, int level) {
		if (goal.isEmpty()) {
	...
	private String selectOne(Set<String> goal) {
	...
	public Set<String> addedTypes() {
		...
		Set<String> addedProps = levels.get(CUR_LEVEL).P.props;
		for (String prop : addedProps) {
			result.add(prop);
		}
		return result;
	}

	public boolean reach(int k, Set<String> subgoal) {
		return levels.get(k).reach(subgoal);
	}

	public boolean reach(Set<String> goal) {
